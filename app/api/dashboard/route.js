...
export async function GET(request) {
  ...
  try {
    const result = await prisma.dRClassification.groupBy({
      by: ["eyeSide", "severity"],
      _count: {
        _all: true,
      },
    ...
    const classifications = await prisma.dRClassification.count();

    return new Response(
      JSON.stringify({ result, patients, physicians, classifications }),
      {
        headers: {
